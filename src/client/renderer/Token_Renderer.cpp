...
void Token_Renderer::scale_token(float scale_x, float scale_y)
{
    this->sprite.setScale(scale_x, scale_y);
}

void Token_Renderer::scale_text(float scale_x, float scale_y)
{
    this->number.setCharacterSize(std::min(70 * scale_x, 70 * scale_y));
}
