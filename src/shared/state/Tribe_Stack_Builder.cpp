...
std::unordered_map<std::string, std::function<std::shared_ptr<effects::Power_Description>()>>
    str_to_power = {
        {"Alchemist",
         []() { return std::make_shared<effects::Power_Description>("Alchemist", 4); }},
        ...
        {"Hill", []() { return std::make_shared<effects::Power_Description>("Hill", 4); }},
        {"Merchant", []() { return std::make_shared<effects::Power_Description>("Merchant", 2); }},
        {"Mounted", []() { return std::make_shared<effects::Power_Description>("Mounted", 5); }},
        {"Pillaging",
         []() { return std::make_shared<effects::Power_Description>("Pillaging", 5); }},
        {"Seafaring",
         []() { return std::make_shared<effects::Power_Description>("Seafaring", 5); }},
        ...
        {"Swamp", []() { return std::make_shared<effects::Power_Description>("Swamp", 4); }},
        {"Underworld",
         []() { return std::make_shared<effects::Power_Description>("Underworld", 5); }},
        ...
        {"Flying", []() { return std::make_shared<effects::Power_Description>("Flying", 5); }},
        {"Forest", []() { return std::make_shared<effects::Power_Description>("Forest", 4); }},
        {"Fortified",
