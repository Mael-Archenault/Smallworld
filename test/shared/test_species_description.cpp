...
class Species_Description_Observer : public state::Species_Description
{
public:
  Species_Description_Observer(std::string name,
                               int given_units_number,
                               int max_units_number,
                               state::Effects_Bundle effects) : state::Species_Description(name,
                                                                                  given_units_number,
                                                                                  max_units_number,
                                                                                  effects) {};

  int get_given_units_number() { return given_units_number; }
  int get_max_units_number() { return max_units_number; }
