...
BOOST_AUTO_TEST_CASE(Test_Pillaging_Power)
{
    ...
    BOOST_CHECK_EQUAL(pillaging_power.rewards_effect(owned_areas), 0);
    ...
    BOOST_CHECK_EQUAL(pillaging_power.rewards_effect(owned_areas), 1);

    pillaging_power.conquest_effect(&area1);
    pillaging_power.conquest_effect(&area2);
    pillaging_power.conquest_effect(&area3);
    BOOST_CHECK_EQUAL(pillaging_power.rewards_effect(owned_areas), 2);
